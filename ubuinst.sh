#!/bin/bash
#--------------------------
# SCRIPT  TECNO Premium
# CANAL TELEGRAM: @jhona70
#--------------------------
clear
...
figlet ' TECNO WEB PREMIUM ' | boxes -d stone -p a0v0 | lolcat
...
echo -e "\033[1;31m• \033[1;33mSOLICITE SUA KEY PELO TELEGRAM @jhona70\033[0m"| lolcat
...
exit;
  ...
  echo -e 'by: @jhona70' >/usr/lib/telegram
  msg -bar
...
echo ""
echo -e "TECNO WEB PREMIUM   " | figlet | boxes -d stone -p a0v0 | lolcat
echo -e "                              \033[1;31mBy @jhona70\033[1;36m" | lolcat
echo ""
chave=$(curl -sSL "raw.githubusercontent.com/Projectsreydassh/webpremium/main/chave") &>/dev/null
...
echo -e "\033[1;33m MAIS INFORMAÇÕES \033[1;31m(\033[1;36mTELEGRAM\033[1;31m): \033[1;37m@jhona70\033[0m" | lolcat
echo ""
